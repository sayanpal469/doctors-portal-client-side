...
const Contact = () => {
    return (
        <div className='contact mt-28 text-center'>
            <div className='pt-10'>
            ...
            <form className='lg:max-w-lg mt-10 px-4 mx-auto'>
                ...
                <div className="mb-6">
                    <textarea type="textarea" id="password" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 h-36 dark:focus:border-blue-500" placeholder='Your message' required/>
                </div>
